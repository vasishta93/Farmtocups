!(function (e, t) {
            ...
            for ("boolean" == typeof s && ((l = s), (s = arguments[a] || {}), a++), "object" == typeof s || E.isFunction(s) || (s = {}), a === u && ((s = this), a--); a < u; a++)
                if (null != (e = arguments[a]))
                    for (t in e)
                        (n = s[t]),
                            s !== (r = e[t]) &&
                                (l && r && (E.isPlainObject(r) || (i = E.isArray(r))) ? ((o = i ? ((i = !1), n && E.isArray(n) ? n : []) : n && E.isPlainObject(n) ? n : {}), (s[t] = E.extend(l, o, r))) : void 0 !== r && (s[t] = r));
            return s;
        }),
        E.extend({
    ...
    var d = (function (n) {
        ...
        (T = re.setDocument = function (e) {
            ...
            return (
                r !== C &&
                    ...
                    (h.matchesSelector = K.test((d = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector))) &&
                        se(function (e) {
        ...
        (re.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== C && T(e), (t = t.replace(U, "='$1']")), h.matchesSelector && k && !D[t + " "] && (!c || !c.test(t)) && (!m || !m.test(t))))
                try {
                    var n = d.call(e, t);
            ...
            preFilter: {
                ...
                PSEUDO: function (e) {
                    ...
                    return G.CHILD.test(e[0])
                        ? null
                        : (e[3] ? (e[2] = e[4] || e[5] || "") : n && V.test(n) && (t = g(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function (e) {
                        ...
                        : function (e, t, n) {
                              ...
                              if (c) {
                                  ...
                                  if (((u = [y ? c.firstChild : c.lastChild]), y && p)) {
                                      for (
                                          d = (a = (r = (i = (o = (s = c)[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === N && r[1]) && r[2], s = a && c.childNodes[a];
                                      ...
                                      for (
                                          ;
                                          (s = (++a && s && s[l]) || (d = a = 0) || u.pop()) &&
                                          ((x ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++d || (p && ((i = (o = s[E] || (s[E] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [N, d]), s !== e));
            ...
            return (
                ...
                oe(function (e, t, n, r) {
                    var i,
                        ...
                        p = g ? (m || (e ? d : l || v) ? [] : t) : f;
                    if ((g && g(f, p, n, r), v)) for (i = me(p, u), v(i, [], n, r), o = i.length; o--; ) (s = i[o]) && (p[u[o]] = !(f[u[o]] = s));
                    if (e) {
                        if (m || d) {
                            if (m) {
            ...
            for (
                ...
                if ((t = b.relative[e[a].type])) c = [ge(ve(c), t)];
                    ...
                    if ((t = b.filter[e[a].type].apply(null, e[a].matches))[E]) {
                        ...
                        return ye(1 < a && ve(c), 1 < a && he(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(_, "$1"), t, a < n && xe(e.slice(a, n)), n < r && xe((e = e.slice(n))), n < r && he(e));
                    }
                    c.push(t);
                }
            return ve(c);
        ...
        return (
            ...
            (g = re.tokenize = function (e, t) {
                ...
                for (s = e, a = [], u = b.preFilter; s; ) {
                    for (o in ((n && !(r = X.exec(s))) || (r && (s = s.slice(r[0].length) || s), a.push((i = []))),
                    (n = !1),
                    (r = z.exec(s)) && ((n = r.shift()), i.push({ value: n, type: r[0].replace(_, " ") }), (s = s.slice(n.length))),
                    b.filter))
                        !(r = G[o].exec(s)) || (u[o] && !(r = u[o](r))) || ((n = r.shift()), i.push({ value: n, type: o, matches: r }), (s = s.slice(n.length)));
                    if (!n) break;
                }
    ...
    (E.Callbacks = function (r) {
        r =
            "string" == typeof r
                ...
                : E.extend({}, r);
        function n() {
            for (o = r.once, t = i = !0; a.length; u = -1) for (e = a.shift(); ++u < s.length; ) !1 === s[u].apply(e[0], e[1]) && r.stopOnFalse && ((u = s.length), (e = !1));
        ...
        E.extend({
            ...
            when: function (e) {
                ...
                var i,
                    ...
                    l = 1 === u ? e : E.Deferred();
                if (1 < a) for (i = new Array(a), n = new Array(a), r = new Array(a); o < a; o++) s[o] && E.isFunction(s[o].promise) ? s[o].promise().progress(t(o, n, i)).done(t(o, r, s)).fail(l.reject) : --u;
        ...
        (E.ready.promise = function (e) {
            return (
                q || ((q = E.Deferred()), "complete" === k.readyState || ("loading" !== k.readyState && !k.documentElement.doScroll) ? C.setTimeout(E.ready) : (k.addEventListener("DOMContentLoaded", H), C.addEventListener("load", H))),
                q.promise(e)
            );
        }),
        E.ready.promise();
    ...
    var F = function (e, t, n, r, i, o, s) {
        var a = 0,
            u = e.length,
            l = null == n;
        if ("object" === E.type(n)) for (a in ((i = !0), n)) F(e, t, a, n[a], !0, o, s);
        else if (
            void 0 !== r &&
            ((i = !0),
            E.isFunction(r) || (s = !0),
    ...
    (E.event = {
            ...
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(L) || [""]).length; l--; )
                    if (((d = g = (a = oe.exec(t[l]) || [])[1]), (h = (a[2] || "").split(".").sort()), d)) {
                        for (f = E.event.special[d] || {}, p = u[(d = (r ? f.delegateType : f.bindType) || d)] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--; )
                            (c = p[o]),
                                (!i && g !== c.origType) ||
                                    (n && n.guid !== c.guid) ||
        ...
        dispatch: function (e) {
            ...
            if ((((a[0] = e).delegateTarget = this), !l.preDispatch || !1 !== l.preDispatch.call(this, e))) {
                for (s = E.event.handlers.call(this, e, u), t = 0; (i = s[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (e.rnamespace && !e.rnamespace.test(o.namespace)) ||
                            ((e.handleObj = o), (e.data = o.data), void 0 !== (r = ((E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
        ...
        if (f && ((t = (e = ne(r, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (l = s[s.length - 1].ownerDocument, E.map(s, me), c = 0; c < a; c++)
                    (u = s[c]), G.test(u.type || "") && !R.access(u, "globalEval") && E.contains(l, u) && (u.src ? E._evalUrl && E._evalUrl(u.src) : E.globalEval(u.textContent.replace(he, "")));
        }
        return n;
    }
    function be(e, t, n) {
        ...
        clone: function (e, t, n) {
            ...
            if (!(v.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || E.isXMLDoc(e)))
                for (s = J(c), r = 0, i = (o = J(e)).length; r < i; r++)
                    (a = o[r]), (u = s[r]), void 0, "input" === (l = u.nodeName.toLowerCase()) && V.test(a.type) ? (u.checked = a.checked) : ("input" !== l && "textarea" !== l) || (u.defaultValue = a.defaultValue);
            if (t)
                if (n) for (o = o || J(e), s = s || J(c), r = 0, i = o.length; r < i; r++) ye(o[r], s[r]);
                else ye(e, c);
    ...
    function ke(e) {
        var t = k,
            n = Te[e];
        return (
            n || (("none" !== (n = Ce(e, t)) && n) || ((t = (we = (we || E("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), (n = Ce(e, t)), we.detach()), (Te[e] = n)), n
        );
    }
    function Ee(e, t, n, r) {
        var i,
    ...
    function Ae(e, t, n) {
        var r,
            ...
            a = e.style;
        return (
            ("" !== (s = (n = n || je(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== s) || E.contains(e.ownerDocument, e) || (s = E.style(e, t)),
            n && !v.pixelMarginRight() && Se.test(s) && Ne.test(t) && ((r = a.width), (i = a.minWidth), (o = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = r), (a.minWidth = i), (a.maxWidth = o)),
            void 0 !== s ? s + "" : s
        );
    }
    function qe(e, t) {
    ...
    function Ie(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; o < 4; o += 2)
            "margin" === n && (s += E.css(e, n + z[o], !0, i)),
                r
                    ? ("content" === n && (s -= E.css(e, "padding" + z[o], !0, i)), "margin" !== n && (s -= E.css(e, "border" + z[o] + "Width", !0, i)))
                    : ((s += E.css(e, "padding" + z[o], !0, i)), "padding" !== n && (s += E.css(e, "border" + z[o] + "Width", !0, i)));
        return s;
    }
    function We(e, t, n) {
        var r = !0,
    ...
    function $e(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; s < a; s++)
            (r = e[s]).style &&
                ...
                (n = r.style.display),
                t
                    ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && B(r) && (o[s] = R.access(r, "olddisplay", ke(r.nodeName))))
                    : ((i = B(r)), ("none" === n && i) || R.set(r, "olddisplay", i ? n : E.css(r, "display"))));
    ...
    E.extend({
        ...
        (E.cssHooks.marginRight = qe(v.reliableMarginRight, function (e, t) {
            return t ? Ee(e, { display: "inline-block" }, Ae, [e, "marginRight"]) : void 0;
        })),
    ...
    (E.Animation = E.extend(Ze, {
        ...
        prefilters: [
            function (t, e, n) {
                ...
                1 === t.nodeType &&
                    ...
                    ((n.overflow = [p.overflow, p.overflowX, p.overflowY]), "inline" === ("none" === (l = E.css(t, "display")) ? R.get(t, "olddisplay") || ke(t.nodeName) : l) && "none" === E.css(t, "float") && (p.display = "inline-block")),
                n.overflow &&
                    ((p.overflow = "hidden"),
                    c.always(function () {
        ...
        (E.speed = function (e, t, n) {
            var r = e && "object" == typeof e ? E.extend({}, e) : { complete: n || (!n && t) || (E.isFunction(e) && e), duration: e, easing: (n && t) || (t && !E.isFunction(t) && t) };
            return (
                (r.duration = E.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in E.fx.speeds ? E.fx.speeds[r.duration] : E.fx.speeds._default),
        ...
        E.each({ slideDown: Je("show"), slideUp: Je("hide"), slideToggle: Je("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, r) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? E.prop(e, t, n)
                        : ((1 === o && E.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = E.attrHooks[t] || (E.expr.match.bool.test(t) ? et : void 0))),
                          void 0 !== n
                              ? null === n
    ...
    E.fn.extend({
        ...
        toggleClass: function (i, t) {
            ...
            return "boolean" == typeof t && "string" == o
                ...
                : this.each(function () {
                      var e, t, n, r;
                      if ("string" == o) for (t = 0, n = E(this), r = i.match(L) || []; (e = r[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
    ...
    E.extend(E.event, {
            ...
            if (
                ...
                for (i = 0; (o = f[i++]) && !e.isPropagationStopped(); )
                    (e.type = 1 < i ? a : c.bindType || p),
                        ...
                        (l = u && o[u]) && l.apply && O(o) && ((e.result = l.apply(o, t)), !1 === e.result && e.preventDefault());
                return (
                    (e.type = p),
                    r ||
                        ...
                        !O(n) ||
                        (u && E.isFunction(n[p]) && !E.isWindow(n) && ((s = n[u]) && (n[u] = null), n[(E.event.triggered = p)](), (E.event.triggered = void 0), s && (n[u] = s))),
                    e.result
                );
            }
        },
        ...
        E.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (
            e,
            n
        ) {
            E.fn[n] = function (e, t) {
    ...
    (bt.href = lt.href),
        E.extend({
            ...
            ajax: function (e, t) {
                ...
                (f = g.url),
                g.hasContent || (g.data && ((f = g.url += (ft.test(f) ? "&" : "?") + g.data), delete g.data), !1 === g.cache && (g.url = dt.test(f) ? f.replace(dt, "$1_=" + ct++) : f + (ft.test(f) ? "&" : "?") + "_=" + ct++)),
                g.ifModified && (E.lastModified[f] && T.setRequestHeader("If-Modified-Since", E.lastModified[f]), E.etag[f] && T.setRequestHeader("If-None-Match", E.etag[f])),
        ...
        E.each(["get", "post"], function (e, i) {
            E[i] = function (e, t, n, r) {
                return E.isFunction(t) && ((r = r || n), (n = t), (t = void 0)), E.ajax(E.extend({ url: e, type: i, dataType: r, data: t, success: n }, E.isPlainObject(e) && e));
            };
        }),
    ...
    E.ajaxSetup({
        ...
        E.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            return s || "jsonp" === e.dataTypes[0]
                ? ((r = e.jsonpCallback = E.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
        ...
        E.fn.extend({
            offset: function (t) {
                ...
                var e,
                    ...
                    i = { top: 0, left: 0 },
                    o = r && r.ownerDocument;
                return o ? ((e = o.documentElement), E.contains(e, r) ? ((i = r.getBoundingClientRect()), (n = Ft(o)), { top: i.top + n.pageYOffset - e.clientTop, left: i.left + n.pageXOffset - e.clientLeft }) : i) : void 0;
            },
            position: function () {
                if (this[0]) {
                    var e,
                    ...
                    return (
                        ...
                        { top: t.top - r.top - E.css(n, "marginTop", !0), left: t.left - r.left - E.css(n, "marginLeft", !0) }
                    );
                }
            },
